...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dim', type=int, default=2, metavar='N',
                        help='size of the 2D points (default: 2)')
    ...
    parser.add_argument('--output_dim', type=int, default=1, metavar='N',
                        help='size of the lass binary labels (0 or 1) (default: 1)')
    ...
    model = model = SimpleNet(args.input_dim, args.hidden_dim, args.output_dim).to(device)
